---
title: "What Are Project Phases"
description: "There are five key phases in the HCD-Agile process: [Discovery](#phase-1-discovery), [Define](#phase-2-define), [Design](#phase-3-design), [Develop](#phase-4..."
---

# What Are Project Phases

There are five key phases in the HCD-Agile process: [Discovery](#phase-1-discovery), [Define](#phase-2-define), [Design](#phase-3-design), [Develop](#phase-4-develop), and [Deliver](#phase-5-deliver). Each phase includes goals, key activities, AI agent roles, and typical duration.

## Phase-Specific Guides

### Phase 1: Discovery

**File**: [`agents/phases/1-discovery.md`](./1-discovery)
...
**File**: [`agents/phases/2-define.md`](./2-define)
...
**File**: [`agents/phases/3-design.md`](./3-design)
...
**File**: [`agents/phases/4-develop.md`](./4-develop)
